...
import pytest
from source_google_play.source import GooglePlayStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(GooglePlayStream, "path", "v0/example_endpoint")
    mocker.patch.object(GooglePlayStream, "primary_key", "test_primary_key")
    mocker.patch.object(GooglePlayStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = GooglePlayStream()
